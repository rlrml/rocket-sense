...
const STAT_METRIC_KEYS: &str = "ball-opponent-half, possession-time, touches-per-possession, avg-possession-duration, high-aerial-touch-count, control-touch-count, big-boost-pad-count, small-boost-pad-count, big-boost-amount, small-boost-amount";
...
#[utoipa::path(
    ...
    tag = "leaderboards",
    params(
        ("stat" = Option<String>, Query, description = "Materialized stat metric: ball-opponent-half (default), possession-time, touches-per-possession, avg-possession-duration, high-aerial-touch-count, control-touch-count, big-boost-pad-count, small-boost-pad-count, big-boost-amount, or small-boost-amount"),

...
import type { ReplayModel, ReplayPlayerTimelineProjection, ReplayPlayerTimelineSegment, ReplayScene } from "@rlrml/player";
...
export declare class ViewerPlayer extends EventTarget {
    ...
    constructor(container: HTMLElement, adapter: SubtrActorPlayer, options?: ViewerOptions, replay?: ReplayModel | null);
...
export {};
//# sourceMappingURL=ViewerPlayer.d.ts.map
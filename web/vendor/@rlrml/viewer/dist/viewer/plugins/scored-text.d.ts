...
export interface ScoredTextOverlayOptions {
    ...
    /**
     * Where to mount the banner. Defaults to the viewer container so it floats
...
export declare function createScoredTextPlugin(options?: ScoredTextOverlayOptions): ViewerPlugin;

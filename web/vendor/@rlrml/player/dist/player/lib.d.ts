 ...
 * Phase 2).
 */
export declare function createPlayer(container: HTMLElement, replayBytes: Uint8Array, options?: PlayerOptions): Promise<ReplayPlayer>;
/**
 ...
 */
export declare function createPlayerFromParsed(container: HTMLElement, parsed: ReplayLoadResult, options?: PlayerOptions): ReplayPlayer;
...
export type { RecordedCameraSettings, SubtrActorPlayerOptions, ReplayPlayerInfo, } from "./adapter/SubtrActorPlayer.js";
export { loadReplay, parseReplay } from "./adapter/wasm.js";
export { capturePlayerImage, capturePlayerImageFromParsed, capturePlayerImages, capturePlayerImagesFromParsed, } from "./capture.js";
export type { PlayerImageBallCamMode, PlayerImageCamera, PlayerImageCaptureOptions, PlayerImageCaptureRequest, PlayerImageCaptureResult, } from "./capture.js";
export { DEFAULT_ENVIRONMENT_ID, listEnvironments, registerEnvironment, resolveEnvironment, } from "./environments.js";
